...
class DebugMetadata private constructor(context: DefaultExecutionContext) :
    ...
    private fun fetchContinuationStackInOneCall(
        ...
        fun getDefaultValue() = MirrorOfContinuationStack(continuation, emptyList())

        val array = getStackTraceInfoMethod.value(continuation, context) ?: return getDefaultValue()
        try {
